...
class RoadObject(ABC):
    ...
    def lane_distance_to_modified(self, other: 'RoadObject', lane: 'AbstractLane' = None) -> float:
        """
        Compute the signed distance to another object according to position vector [x,y]
        used in road.py in close_vehicles_to() function
